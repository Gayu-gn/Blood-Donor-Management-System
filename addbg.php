...
<body>
  ...
  <main> 
     <div class="text-center p-5"><h1>ADD BLOOD GROUP</h1></div>
      <div class="col-md-11 mb-4">
        <div class="card shadow-lg py-2 ms-2 p-3 bg-white">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                 <label>Add Blood Group Name</label><br><br>
                 <form action="mbg.php" method="POST">
                   <div class="col-md-7">
                   <input type="text" class="form-control" name="blood_group" placeholder="Enter Blood Group Name" autocomplete="off" required><br><br>
                   </div>
