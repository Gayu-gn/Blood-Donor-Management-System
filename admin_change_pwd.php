...
<body>
  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-dark">
    <div class="position-sticky">
      ...
      <?php echo $a_email_id; ?></center>&nbsp &nbsp</span><br>
  ...
  <main>
    <div class="text-center p-3"><h1>Change Password</h1></div>

    <div class="model-dialog ">
    <div class="row" style="margin:3rem 25rem">
      <div class="col-sm-12 main-section">
        <div class="model-content shadow-lg bg-light">
          <div class="col-12 form-input">
            <form action="Change.php" method="POST"><br><br>
              <div class="form-group p-3">
                <div>&nbsp&nbspCurrent Password</div><br>
                <input type="password" class="form-control" placeholder="Enter the Password" id="cpassword" name="oldpassword" required >          
              </div><br>
              <div class="form-group p-3">
                <div>&nbsp&nbspNew Password</div><br>
                <input type="password" class="form-control" placeholder="Enter the Password" id="passwordnew" name="passwordnew" required>
              </div><br>
              <div class="form-group p-3">
                <div>&nbsp&nbspConfirm Password</div><br>
                <input type="password" class="form-control" placeholder="Enter the Password" id="passwordc" name="passwordc" required>
              </div><br>
              <div class="form-group p-3">&nbsp&nbsp&nbsp
                <button type="Change" name="submit" class="btn btn-primary btn-lg btn-block button">Change</button>
              </div><hr>
            </form>
          </div>
        </div> 
...
if($oldpassword == $pass) 
{
  ...
  {    
      $q="update login_admin set a_password='$passwordc' where a_password='$pass' ";
      $r=mysqli_query($conn,$q);
      if($r){
