...
<body>
  ...
  <main>
     <div class="text-center p-5"><h1>MANAGE BLOOD GROUP</h1></div>
      <div class="col-md-11 mb-4">
        <div class="card shadow-lg py-2 ms-5 p-3 bg-white">
          <div class="card-body">
                                ...
                                $con = mysqli_connect("localhost","root","","bdms");
                                  ...
                                  {       
                                    while ($row=mysqli_fetch_assoc($query_run)) {
                                      ...
                                      <td>'.$blood_group.'</td>
                                      <td>
                                      <button class="btn btn-primary"><a href="delete.php?deleteid='.$sno.'" class="text-light" style="text-decoration: none;">DELETE</a></button>
                                      </td>
                                      </tr>';
                                    }
                                  }       
