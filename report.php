...
<body>
  ...
  <main>
    <div class="text-center p-5"><h1><b>Reports</b></h1></div>
      <div class="container">
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-7">
                                <form action="" method="GET">
                                    <div class="input-group mb-3">
                                      <label></label>
                                        <input type="text" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Generate report" autocomplete="off" required>
                                        <button type="submit" class="btn btn-lg btn-warning">Report</button>
                                    </div>
                                </form>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM signup WHERE CONCAT(bgroup) LIKE '%$filtervalues%' ";
