...
<a href="health_dashboard.php" class="list-group-item list-group-item-action bg-dark p-3"><span class="text-white">&nbsp &nbsp <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">
  ...
  <!-- Sidebar -->
  <main>
    <div class="text-center p-3"><h1><b>Update Profile</b></h1></div>
...
<?php
 ...
 $q= "SELECT * FROM signup where password='$pass' ";
...
/*$q="SELECT * FROM signup where email_id='$_SESSION['email_id1']' ";
            ...
            <form action="update.php" method="POST">
              <div class="form-group p-2">
                <div class="row">
                  <div class="col">
                    &nbspFirstname
                    <input type="text" class="form-control" placeholder="Enter Your First Name" name="firstname" value="<?php echo $firstname; ?>" required >         
                  </div>  
                  <div class="col">
                    &nbspLastname
                    <input type="text" class="form-control" placeholder="Enter Your Last Name" name="lastname" value="<?php echo $lastname; ?>" required >         
                  </div>
                </div>
              </div></br>
              <!--<div class="form-group p-2">
                <div class="row">
                  <div class="col">
                    ...
                    <select class="form-select" name="gender" required>
                      <option>/* if($gender=='m'){echo "Male"; $gender='m';} elseif ($gender=='f') {
                        echo "Female"; $gender='f';}
                       else{
                          echo "Others"; $gender='o';
                      } */ echo $gender; ?></option>
              ...
              <div class="form-group p-2">
                <div class="row">
                  <div class="col">
                    &nbspEmail ID
                    <input type="email" class="form-control" placeholder="Enter Your Email Id" name="email_id" value="<?php echo $email_id; ?>" required >         
                  </div>  
                  <div class="col">
                    &nbspPhone number
                    <input type="number" class="form-control" placeholder="Enter Your Contact Number" name="phoneno" value="<?php echo $phoneno; ?>" required >         
                  </div>
                </div>
              </div></br>
              <div class="form-group p-2">
                <div class="row">
                  <div class="col">
                    &nbspState
                    <input type="text" class="form-control" placeholder="Enter Your State" name="state" value="<?php echo $state; ?>" required >          
                  </div>  
                  <div class="col">
                    &nbspCity
