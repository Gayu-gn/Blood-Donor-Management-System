      ...
      <div class="col-sm-12 main-section">
        <div class="model-content shadow-lg bg-light">
          <div class="col-12 form-input">
            <form action="userpwd.php" method="POST"><br><br>
              <div class="form-group p-3">
                <div>&nbsp&nbspCurrent Password</div><br>
                <input type="password" class="form-control" placeholder="Enter the Password" id="cpassword" name="cpassword" required >          
              </div><br>
              <div class="form-group p-3">
              ...
              <div class="form-group p-3">&nbsp&nbsp&nbsp
                <button type="Change" class="btn btn-primary btn-lg btn-block button">Change</button>
              </div><hr>
            </form>
          </div>
        </div> 
