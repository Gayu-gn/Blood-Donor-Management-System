...
<body>
  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-dark">
    <div class="position-sticky">
      ...
      <br><a href="admindashboard.php" class="list-group-item list-group-item-action bg-dark p-3"
  ...
  <main>
    ...
    ?>
     ...
     <div class="text-center p-5"><h1><b>Welcome!</b></h1></div>
     <div class="row">
      <div class="col-md-6 mb-4">
        <div class="card shadow-lg py-2 ms-2 p-3 bg-primary">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 text-light">Total Users</div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                        $query = "SELECT email_id FROM signup";  
      ...
      <div class="col-md-6 mb-4">
        <div class="card shadow-lg py-2 p-3 bg-primary">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                  <div class="text-xs font-weight-bold text-primary text-uppercase mb-1 text-light">Total blood groups</div>
                  <div class="h5 mb-0 font-weight-bold text-gray-800">
                      <?php
                        $query = "SELECT blood_group FROM bg";  
                        $query_run = mysqli_query($con, $query);
                        $row = mysqli_num_rows($query_run);
                        echo $row;
                      ?>
